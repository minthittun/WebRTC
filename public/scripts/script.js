...
function hangUp()
{
    ...
    socketIdList.forEach(function (socket) {
        ...
        if (socket != socketId) {
            var video = document.querySelector('[data-socket="' + socket + '"]');
    ...
    document.getElementById("call_done").style.display = "block";
    */
}
//Hang up
...
function gotRemoteStream(event, id, count) {
    ...
    var videos = document.querySelectorAll('video'),
        btnPinUnpin = document.createElement('button'),
        video = document.createElement('video'),
        div = document.createElement('div')

    btnPinUnpin.classList.add("btnPin");
    ...
    btnPinUnpin.onclick = function () {
        var parentDiv = video.parentElement;
        marginLeft = parentDiv.style.marginLeft;
        zIndex = parentDiv.style.zIndex;

        if (isFullScreen) {

            //change pin css

            btnPinUnpin.classList.remove("btnUnpin");
            btnPinUnpin.classList.add("btnPin");
            ...
            parentDiv.style.marginLeft = marginLeft;
            ...
            btnPinUnpin.classList.remove("btnPin");
            btnPinUnpin.classList.add("btnUnpin");
            ...
            connections[fromId].setRemoteDescription(new window.RTCSessionDescription(signal.sdp)).then(function () {
                if (signal.sdp.type == 'offer') {
                    connections[fromId].createAnswer().then(function (description) {
                        ...
                        test.sdp = setMediaBitrates(description.sdp)

                        connections[fromId].setLocalDescription(test).then(function () {
